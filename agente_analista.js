...
async function generarAnalisisNocturno() {
  ...
  const prompt = `Eres el analista de ventas y calidad de AQUA, tienda de peces ornamentales en Colombia.
...
Analiza estas conversaciones y genera un reporte nocturno con:

1. RESUMEN DEL DÍA (2 líneas): tasa de conversión, productos más pedidos

2. LO QUE FUNCIONÓ BIEN: 2-3 momentos donde Pulpín vendió bien o asesoró excelente

3. OPORTUNIDADES PERDIDAS: Conversaciones donde el cliente se fue sin comprar — ¿qué falló? ¿fue el precio, la respuesta, la demora, algo que Pulpín no supo responder?

4. CLIENTES QUE NECESITAN SEGUIMIENTO: Números o nombres de clientes que mostraron interés serio pero no compraron (para que el equipo los contacte mañana)

5. MEJORAS PARA PULPÍN (máximo 3, muy concretas): Frases exactas que Pulpín debería decir diferente, información que le falta, palabras clave que no está detectando, o productos que no tiene en catálogo pero preguntaron

6. PRODUCTO ESTRELLA MAÑANA: El producto que más interés generó hoy — sugiere cómo destacarlo en los estados de mañana

Sé directo y específico. Sin flores. Máximo 30 líneas. En español colombiano natural.`;
